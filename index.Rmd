...
### **<span style="color:#7d9029"> Ovitrampas </span>**
<html>
<head>
<style>
.myDiv1 {
...
```{r echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center",cache = TRUE, fig.show = "hold", fig.cap= "Figura 1. Mapa de las localidad de alto riesgo (en gris) y localidades con ovitrampas (en rojo)"}
