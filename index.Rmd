...
<div class="myDiv1">
  ...
  <p></p>
#### **<span style="color:#7d9029">Canal Endémico </span>**
```{r echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center",cache = TRUE, fig.show = "hold", fig.cap= "Figura 1. Mapa de las localidad de alto (en gris) y localidades con ovitrampas (en rojo)"}
