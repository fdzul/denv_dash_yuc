...
```{r indicador_ovitrampas, echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center", fig.show = "hold"}
...
```{r manzanas_calientes, echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center", fig.show = "hold"}
library(magrittr)
...
y <- rgeomex::extract_ageb(locality = "Mérida", cve_geo = "31")

# Step 3. hotblocks #####
boldenr::hot_blocks(loc = "Mérida",
                    x = ovis,
                    blocks = x,
                    cve_mpo = unique(x[y$locality, ]$MUNICIPIO),
...
## Predición del Número de Huevos área urbana de **Mérida**  semana `r lubridate::epiweek(Sys.Date())-1`
```{r, echo=FALSE, error=TRUE, message=FALSE,dpi=300, warning=FALSE, fig.align = "center", out.width="70%",cache = TRUE, fig.show = "hold", fig.cap= "Figura 6. Predicción del número de huevos en área urbana de Pánuco"}
path_vect <- "C:/Users/HOME/Dropbox/cenaprece_datasets/2022/31_yucatan"
path_coord <- paste(path_vect, "DescargaOvitrampasMesFco")
