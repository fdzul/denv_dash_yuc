...
#### **<span style="color:#7d9029">Indicador de Ovitrampas por Casas</span>**
...
#### **<span style="color:#7d9029">Indicador de Ovitrampas por Manzana</span>**
...
### **<span style="color:#7d9029">Yucatan (Probables)</span>**

```{r cadenas_yucatan_probable}
# Step 1. load the dengue geocoded dataset
load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2022/9.RData_geocoded/geo_den_mx_31_merida_2022_10_31.RData")
# Step 2. load the transmission_chains_map function ####
source("~/Dropbox/r_developments/r_new_functions/3.Functions/transmission_chains_map.R")
transmission_chains_map(geocoded_dataset = y,
                                    cve_edo = "31",
                                    locality = NULL,
                                    dengue_cases = "Probable")
```

### **<span style="color:#7d9029">Yucatan (Confirmados)</span>**
...
### **<span style="color:#7d9029">Mérida (Probables)</span>**
...
### **<span style="color:#7d9029">Mérida (Confirmados)</span>**
...
### **<span style="color:#7d9029">Valladolid (Probables)</span>**
...
### **<span style="color:#7d9029">Valladolid (Confirmados)</span>**
...
### **<span style="color:#7d9029">Temozon (Probables)</span>**

```{r cadenas_temozon_probable}
# Step 1. load the dengue geocoded dataset
load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2022/9.RData_geocoded/geo_den_mx_31_merida_2022_10_31.RData")
# Step 2. load the transmission_chains_map function ####
source("~/Dropbox/r_developments/r_new_functions/3.Functions/transmission_chains_map.R")
...
### **<span style="color:#7d9029">Temozon (Confirmados)</span>**

```{r cadenas_temozon_confirmados}
# Step 1. load the dengue geocoded dataset
load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2022/9.RData_geocoded/geo_den_mx_31_merida_2022_10_31.RData")
# Step 2. load the transmission_chains_map function ####
source("~/Dropbox/r_developments/r_new_functions/3.Functions/transmission_chains_map.R")
