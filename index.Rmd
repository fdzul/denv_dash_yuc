...
### **<span style="color:#7d9029">Yucatan </span>**
...
# Step 2. load the transmission_chains_map function ####
source("~/Dropbox/r_developments/r_new_functions/3.Functions/transmission_chains_map.R")
confirmado <- transmission_chains_map(geocoded_dataset = y,
                                    cve_edo = "31",
                                    locality = NULL,
                                    dengue_cases = "Confirmado")
probable <- transmission_chains_map(geocoded_dataset = y,
                                    cve_edo = "31",
                                    locality = NULL,
                                    dengue_cases = "Probable")

leafsync::sync(list(probable, 
                    confirmado))
